...
Also, because the pattern file are separate from the source file, if you don't mind the effort of coding, you can use pattern data for one instruction set to generate machine code for a processor with a different instruction set. It is retargetable.
