...
aからnまでは項で、例えば、ld a,1+2はエラーになるので、式を指定したい場合は、ld a,(1+2)としてください。
...
https://gist.github.com/fygar256/5a5afd9b4fc580b285089727e718e53f
...
・当たり前ですが、LISPマシンは記述できません。LISPマシンのプログラムリストはアセンブルリストとは言わないらしいです。
